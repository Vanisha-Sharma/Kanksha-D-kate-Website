...
export default function ServicesPage() {
  ...
  const faqData = [
    {
      ...
      answer:
        "¡FLo! works at the neurological level through Quanta Installation Technology, creating permanent shifts in your internal operating system rather than temporary behavioral changes. It's precision neuroscience, not motivation.",
    },
    {
    ...
    {
      question: "What's the difference between online and offline sessions?",
      answer:
        "Both formats are equally effective. Online sessions offer convenience and global accessibility, while offline sessions in Mumbai provide an immersive in-person experience.",
    },
  ];
  ...
  const benefitTiles = [
    ...
    },
    {
      ...
      description:
        "Countless evolutionary breakthroughs unfold, unique and beneficial to each individual's matrix.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed mt-6">
              Each individual is welcomed into a 1:1 high-touch experience,
              curated to initiate rapid internal refinements that ripple across
              every life dimension from business performance to emotional
              mastery, deeper relationships to personal equilibrium. At ¡FLo!,
              all changes happen during the installation cycles and there's
              nothing you need to do afterward. You'll start noticing shifts
              naturally as the cycles progress.
            </p>
          ...
          <div className="text-center mt-16">
            ...
            >
              <span className="text-lg font-medium">
                Read More About What You Engage In
              </span>
                  ...
                  <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6 text-left">
                      ...
                      <div className="space-y-4">
                        {[
                          "Strategic Multi-Layered Diagnostics",
                          "Analysis of Personal Matrix for Evolution",
                          "Three Advanced Quanta Installation Cycles curated for specific evolutionary shifts",
                          "14-Month Engagement with Kanksha D'Kate",
                          "Lifetime of FLo effect",
                          "Exclusive access to closed-door events or immersions hosted by Kanksha (For registrations before September 2025. T&C apply)",
                        ].map((item, index) => (
                          <div
                            key={index}
                    ...
                    <div className="space-y-6 text-left">
                      <div className="flex items-center space-x-4 mb-8">
                        ...
                        <h5 className="text-2xl font-bold text-orange-400">
                          ¡FLo! Stream
                        </h5>
                      </div>

                      <p className="text-lg text-gray-200 mb-6 text-left">
                        You engage in two laser-focused sessions where we zero
                      ...
                      <div className="space-y-4">
                        {[
                          "Specific breakthrough needed in one area",
                          "Targeted challenge resolution",
                          "Quick transformation catalyst",
                          "Creating ripple effects across life domains",
                          "Testing ¡FLo! methodology",
                        ].map((item, index) => (
                          <div
                            key={index}
                            className="flex items-start space-x-3"
                          >
                            <ArrowRight className="w-5 h-5 text-orange-400 mt-1 flex-shrink-0" />
                            <span className="text-gray-300 text-left">
                              {item}
                            </span>
                          </div>
            ...
            <div className="bg-gradient-to-br from-stone-900/40 to-gray-900/40 rounded-3xl p-8 border border-stone-500/20 backdrop-blur-sm">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse min-w-[600px]">
                  ...
                  <tbody>
                    {[
                      ["Duration", "14 Months", "2 Sessions"],
                      [
                        "Installation Cycles",
                        "3 Advanced Cycles",
                        "1 Focused Cycle",
                      ],
                      ["Personal Diagnostics", "Multi-Layered", "Targeted"],
                      ["Ongoing Support", "Lifetime Access", "Session-Based"],
      ...
      <section className="py-32 px-4 bg-gradient-to-br from-stone-900/60 to-gray-900/60">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-stone-900/80 to-gray-900/80 rounded-3xl p-8 sm:p-12 lg:p-16 border border-stone-500/30 backdrop-blur-sm">
            <div className="text-center mb-20">
              <h2 className="text-5xl font-bold mb-6 text-shimmer animate-gradient-shift">
      ...
      <section className="py-32 px-4 bg-gradient-to-br from-gray-900/60 to-stone-900/60">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900/80 to-stone-900/80 rounded-3xl p-8 sm:p-12 lg:p-16 border border-stone-500/30 backdrop-blur-sm">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-6 text-shimmer animate-gradient-shift">
